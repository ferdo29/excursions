...
export const CirclesAb = ({}) => {
    ...
    return (
        <>
            ...
            <Svg style={{position: 'absolute', bottom: -30, zIndex: -2}} width={width} height={height > 755 ? "167" : "147"} viewBox={`0 0 ${width} ${height > 755 ? "167" : "147"}`} fill="none" xmlns="http://www.w3.org/2000/svg">
