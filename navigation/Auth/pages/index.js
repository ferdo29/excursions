            ...
            <ContainerMain style={{alignItems: 'flex-start'}}>
                ...
                <BoxRowView style={{paddingBottom: 37}}>
                    <BoxColumnView style={{alignItems: 'flex-start'}}>
                        ...
                        <TouchableOpacity activeOpacity={0.6}>
                            ...
                            }}>{t("Login by phone.Enter here")}</Text14>
                        </TouchableOpacity>
                ...
                <BoxColumnView style={{alignItems: 'flex-start', paddingBottom: 20}}>
                    <Text33 style={{color: '#fff'}}>{
                        t("Login by phone.And so, let's go")
                    }</Text33>
                    <Text16 style={{color: '#fff', paddingTop: 16}}>{
                        t("Login by phone.Enter your phone number and we will send you a login code")
                    }</Text16>
                </BoxColumnView>
                ...
                {stateLogin === 'Email' &&
                <ButtonWhiteOpacity style={{width: width >= 428 ? 375 : '100%'}} onPress={handlerStateLogin}
                                    activeOpacity={0.6}>
                    ...
                    <Text14
                        style={{
                            color: '#fff',
                            marginLeft: 40
                        }}>{t('Login by phone.Continue through')} {t('Login by phone.Phone')}</Text14>
                </ButtonWhiteOpacity>}
                {stateLogin === 'Phone' &&
                <ButtonWhiteOpacity style={{width: width >= 428 ? 375 : '100%'}} onPress={handlerStateLogin}
                                    activeOpacity={0.6}>
                    <Svg width="24" height="24" viewBox={'0 -3 24 24'} fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                        <Path
                    ...
                    <Text14
                        style={{color: '#fff', marginLeft: 40}}>{t('Login by phone.Continue through')} Email</Text14>
                </ButtonWhiteOpacity>}
                <AuthGoogle/>
                <AuthFacebook/>
